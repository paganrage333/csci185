...
function mouseDragged(){
    ...
    if (shape === 'circle') {
        ...
        quad(mouseX, mouseY, mouseX + size*1.5, mouseY + size*1.5, mouseX + size*1.5, mouseY - size*1.5, mouseX - size*2, mouseY + size*2)
    } else {
      triangle(
            mouseX, mouseY - size/3, 
            mouseX - size/2, mouseY + size/3, 
            mouseX + size/2, mouseY +size/3,  
        );
    }
